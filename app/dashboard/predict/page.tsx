          ...
          <AnimatePresence mode="wait">
            {apiStatus === 'checking' && (
              <motion.div
                ...
                className="flex items-center gap-2 px-4 py-2 rounded-2xl bg-card border text-xs text-muted-foreground"
              >
            ...
            {apiStatus === 'online' && (
              <motion.div
                ...
                animate={{ opacity: 1, scale: 1 }}
                exit={{ opacity: 0, scale: 0.9 }}
                className="flex items-center gap-2 px-4 py-2 rounded-2xl bg-emerald-500/10 border border-emerald-500/30 text-xs font-semibold text-emerald-500"
              >
            ...
            {apiStatus === 'offline' && (
              <motion.div
                ...
                animate={{ opacity: 1, scale: 1 }}
                exit={{ opacity: 0, scale: 0.9 }}
                className="flex items-center gap-2 px-4 py-2 rounded-2xl bg-rose-500/10 border border-rose-500/30 text-xs font-semibold text-rose-500 animate-pulse"
              >
